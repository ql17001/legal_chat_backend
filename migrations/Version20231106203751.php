 ...
 */
final class Version20231106203751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE asesoria (id INT AUTO_INCREMENT NOT NULL, id_cliente_id INT NOT NULL, nombre VARCHAR(100) NOT NULL, estado VARCHAR(1) NOT NULL, fecha DATE NOT NULL, INDEX IDX_F8126B477BF9CE86 (id_cliente_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
